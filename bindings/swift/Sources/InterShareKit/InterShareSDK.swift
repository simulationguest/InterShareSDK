    ...
    InternalNearbyServerProtocol
{
    ...
    open func handleIncomingBleConnection(connectionId: String, nativeStream: NativeStreamDelegate) {
        try!
            rustCall {
    ...
    open func handleIncomingConnection(nativeStreamHandle: NativeStreamDelegate) {
        try!
            rustCall {
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_intershare_sdk_ffi_checksum_method_internalnearbyserver_add_ble_implementation() != 38334 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_intershare_sdk_ffi_checksum_method_internalnearbyserver_add_l2_cap_client() != 18554 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_intershare_sdk_ffi_checksum_method_internalnearbyserver_change_device() != 28277 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_intershare_sdk_ffi_checksum_method_internalnearbyserver_handle_incoming_connection() != 42612 {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if uniffi_intershare_sdk_ffi_checksum_method_internalnearbyserver_set_tcp_details() != 860 {
        return InitializationResult.apiChecksumMismatch
    }
